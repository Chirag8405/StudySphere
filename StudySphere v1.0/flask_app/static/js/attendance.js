document.addEventListener('DOMContentLoaded', function() {
    ...
    createTimetableBtn.addEventListener('click', () => {
        createTimetableSection.style.display = createTimetableSection.style.display === 'none' ? 'block' : 'none';
    });
...
function recordTimetable(userId, subject, time, days) {
    ...
    .then(data => {
        ...
        timetableForm.reset(); // Reset the form
        fetchTimetable(userId); // Refresh timetable records
        createTimetableSection.style.display = 'none'; // Hide the form after submission
    })
    .catch(error => {
