...
from app.models import create_assignment, get_assignments, delete_assignment,mark_assignment_as_cancelled, mark_assignment_as_done, update_assignment
...
@routes.route('/api/attendance', methods=['GET', 'POST'])
...
@routes.route('/api/timetable', methods=['GET', 'POST'])
def handle_timetable():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return jsonify({'message': 'An error occurred while fetching timetable entries.'}), 500
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return jsonify({'message': 'An error occurred while creating the timetable entry.'}), 500
