...
function getUserId() {
            ...
            .then(assignments => {
                ...
                assignments.forEach(assignment => {
                    ...
                    assignmentDiv.innerHTML = `
                        ...
                        <button class="complete-btn" data-assignment-id="${assignment.id}">Complete</button>
    ...
    modifyForm.addEventListener("submit", function (event) {
        ...
        .then(data => {
            console.log(data.message);
            fetchAssignments(); // Refresh the assignments list
            document.getElementById("modify-assignment").style.display = "none"; // Hide the modify form
        })
