...
from app.models import fetch_attendance, fetch_timetable, update_attendance, add_timetable_entry,get_user_profile, get_assignments_summary, get_attendance_summary, get_user_interests
