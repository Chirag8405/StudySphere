document.addEventListener("DOMContentLoaded", function () {
    ...
    fetchAssignments(userId); // Fetch assignments on page load
    ...
    function fetchAssignments(userId) {
        fetch(`/api/assignments?user_id=${userId}`)
            ...
            .then(assignments => {
                console.log("API Response:", assignments); // Log the API response

                displayAssignments(assignments); // Display assignments
            })
    ...
    function displayAssignments(assignments) {
        ...
        assignments.forEach(assignment => {
            ...
            assignmentDiv.innerHTML = `
                <p>${assignment.name} (Due: ${assignment.due_date}) - Status: ${assignment.status}</p>
        ...
        addEventListenersToButtons(); // Add event listeners to buttons
    }
    ...
    assignmentForm.addEventListener("submit", function (event) {
        ...
        .then(data => {
            ...
            fetchAssignments(userId); // Refresh the assignments list
